import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { computed, mergeProps, unref, withCtx, renderSlot, openBlock, createBlock, defineComponent, provide, useModel, createVNode, createTextVNode, toDisplayString, createCommentVNode, mergeModels, shallowRef, getCurrentInstance, cloneVNode, h, createElementBlock, watch, toValue as toValue$1, ref, inject, hasInjectionContext, Suspense, toRef as toRef$1, camelize as camelize$1, getCurrentScope, useSlots, Teleport, shallowReadonly, customRef, effectScope, watchEffect, readonly, toHandlerKey, onScopeDispose, nextTick, toRefs, resolveDynamicComponent, Fragment, renderList, Comment, markRaw, isRef, resolveComponent, onServerPrefetch, reactive, shallowReactive, defineAsyncComponent, useSSRContext, createApp, useId, onErrorCaptured, useTemplateRef, withModifiers, normalizeProps, guardReactiveProps, normalizeStyle, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { av as defu, aC as hasProtocol, aD as isScriptProtocol, aE as joinURL, ay as klona, aF as withQuery, aG as sanitizeStatusCode, aH as parseURL$1, aI as encodePath$1, aJ as decodePath, aK as parseQuery$1, aL as defuFn, aM as getContext, aN as withTrailingSlash, aO as withoutTrailingSlash, c as createError$1, aP as $fetch$1, aQ as baseURL, aR as executeAsync } from '../nitro/nitro.mjs';
...
const unhead_WFn8o_qGPfIkJLLNM6_xzJ_5V4YuzQ3Mkdo4U67ozBA = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
function createMemoryHistory(base = "") {
  ...
  function setLocation(location2, state2 = {}) {
    position++;
    if (position !== queue.length) queue.splice(position);
    queue.push([location2, state2]);
  }
...
function createRouter(options) {
  ...
  function finalizeNavigation(toLocation, from, isPush, replace2, data) {
    ...
    const state2 = {};
    if (isPush) if (replace2 || isFirstNavigation) routerHistory.replace(toLocation.fullPath, assign({ scroll: isFirstNavigation && state2 && state2.scroll }, data));
...
const _routes = [
  {
    name: "network-ftth-diagnostics",
    path: "/network/ftth/diagnostics",
    component: () => import('./diagnostics-D4iIDcPI.mjs')
  },
  {
    name: "network-ftth-imports",
    path: "/network/ftth/imports",
    component: () => import('./imports-UP1Uy9iD.mjs')
  },
  {
    name: "network-ftth-mac-map",
    path: "/network/ftth/mac-map",
    component: () => import('./mac-map-CS_19TJq.mjs')
  },
  {
    name: "network-ftth-olts",
    path: "/network/ftth/olts",
    component: () => import('./olts-DBtKI7Ws.mjs')
  },
  {
    name: "network-ftth-onus",
    path: "/network/ftth/onus",
    component: () => import('./onus-Dxb2JxnT.mjs')
  },
  {
    name: "network-ftth-pons",
    path: "/network/ftth/pons",
    component: () => import('./pons-DDBAtRMM.mjs')
  },
  {
    name: "automation-definitions",
    path: "/automation/definitions",
    component: () => import('./definitions-D83F4JMR.mjs')
  },
  {
    name: "automation-scripts",
    path: "/automation/scripts",
    component: () => import('./scripts-CzVF9Czk.mjs')
  },
  {
    name: "billing-assignments",
    path: "/billing/assignments",
    component: () => import('./assignments-B0YcXYLw.mjs')
  },
  {
    name: "billing-subscriptions",
    path: "/billing/subscriptions",
    component: () => import('./subscriptions-C13Iz-8Q.mjs')
  },
  {
    name: "billing-tariffs",
    path: "/billing/tariffs",
    component: () => import('./tariffs-D6dSx8ru.mjs')
  },
  {
    name: "crm-customer-devices",
    path: "/crm/customer-devices",
    component: () => import('./customer-devices-Gb9xOCI_.mjs')
  },
  {
    name: "crm-customers",
    path: "/crm/customers",
    component: () => import('./customers-Dzn4PEyM.mjs')
  },
  {
    name: "network-access-profiles",
    path: "/network/access-profiles",
    component: () => import('./access-profiles-N9h5xAfV.mjs')
  },
  {
    name: "network-equipment",
    path: "/network/equipment",
    component: () => import('./equipment-PVQ7yf3v.mjs')
  },
  {
    name: "network-ftth",
    path: "/network/ftth",
    component: () => import('./index-Bt_JcpOL.mjs')
  },
  {
    name: "network-imports",
    path: "/network/imports",
    component: () => import('./imports-Cm_k2Q2p.mjs')
  },
  {
    name: "network-lines",
    path: "/network/lines",
    component: () => import('./lines-DxUBPdMc.mjs')
  },
  {
    name: "network-nodes",
    path: "/network/nodes",
    component: () => import('./nodes-9I2h8HEG.mjs')
  },
  {
    name: "pit-validation",
    path: "/pit/validation",
    component: () => import('./validation-DmR89HJo.mjs')
  },
  {
    name: "system-dictionaries",
    path: "/system/dictionaries",
    component: () => import('./dictionaries-COPFr0ve.mjs')
  },
  {
    name: "customers",
    path: "/customers",
    component: () => import('./customers-BYu0c6TY.mjs')
  },
  {
    name: "inbox",
    path: "/inbox",
    component: () => import('./inbox-C0Xcdop3.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./login-DaNx4fdK.mjs')
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/settings",
    component: () => import('./settings-G2v98J1j.mjs'),
    children: [
      {
        name: "settings-members",
        path: "members",
        component: () => import('./members-Pq-YL6pV.mjs')
      },
      {
        name: "settings-notifications",
        path: "notifications",
        component: () => import('./notifications-DO55do4j.mjs')
      },
      {
        name: "settings-security",
        path: "security",
        component: () => import('./security-urRQDthE.mjs')
      },
      {
        name: "settings",
        path: "",
        component: () => import('./index-B2YrgjVD.mjs')
      }
    ]
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DmgQX54B.mjs')
  }
];
...
const revive_payload_server_fzj9nwKVTGBRfQ9idnXQpEzQYKDxoGG5bEqOS8zwNCg = /* @__PURE__ */ defineNuxtPlugin({
...
const plugin_EgC9iCgnaQZi0BMYP9WG9fcj6Rw4__4q38HIA11oHqY = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
...
const colors_8hMxoSY6b98AT5uzuS9ZKDGqi0SKZZkVOKAMAxyO3UI = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugins = [
  unhead_WFn8o_qGPfIkJLLNM6_xzJ_5V4YuzQ3Mkdo4U67ozBA,
  plugin,
  revive_payload_server_fzj9nwKVTGBRfQ9idnXQpEzQYKDxoGG5bEqOS8zwNCg,
  plugin_server_Ns7Kxyh_4Fi2BbVy6T9WU8hHy_zYKd3cgoE6VA9fFBw,
  plugin_EgC9iCgnaQZi0BMYP9WG9fcj6Rw4__4q38HIA11oHqY,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8,
  colors_8hMxoSY6b98AT5uzuS9ZKDGqi0SKZZkVOKAMAxyO3UI
];
...
function formatTimeAgo(from, options = {}, now = Date.now()) {
  ...
  for (const [idx, unit] of units.entries()) {
    if (getValue2(diff2, unit) <= 0 && units[idx - 1]) return format2(diff2, units[idx - 1]);
    if (absDiff < unit.max) return format2(diff2, unit);
  }
...
_sfc_main$e.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/Icon.vue");
...
_sfc_main$d.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/Chip.vue");
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/Avatar.vue");
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/LinkBase.vue");
            ...
            if (_push2) {
              ...
              return [
                __props.custom ? (openBlock(), createBlock(unref(Slot), { key: 0 }, {
                  ...
                  _: 2
                }, 1024)) : (openBlock(), createBlock(_sfc_main$b, mergeProps({ key: 1 }, {
                  ..._ctx.$attrs,
                  ...__props.exact && isExactActive ? { "aria-current": props.ariaCurrentValue } : {},
                  as: __props.as,
                  type: __props.type,
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/Link.vue");
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/Button.vue");
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/Progress.vue");
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/Toast.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/Toaster.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/OverlayProvider.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/App.vue");
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-JWCutDz7.mjs').then((m) => m.default || m))
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!!props.error?.statusCode || !!props.error?.status || !!slots.statusCode) {
              ...
              ssrRenderSlot(_ctx.$slots, "statusCode", {}, () => {
                _push2(`${ssrInterpolate(props.error?.statusCode || props.error?.status)}`);
              }, _push2, _parent2, _scopeId);
              _push2(`</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (!!props.error?.statusMessage || !!props.error?.statusText || !!slots.statusMessage) {
              ...
              ssrRenderSlot(_ctx.$slots, "statusMessage", {}, () => {
                _push2(`${ssrInterpolate(props.error?.statusMessage || props.error?.statusText)}`);
              }, _push2, _parent2, _scopeId);
              _push2(`</h1>`);
            } else {
              _push2(`<!---->`);
            }
            if (props.error?.message && props.error.message !== (props.error.statusMessage || props.error.statusText) || !!slots.message) {
            ...
            return [
              !!props.error?.statusCode || !!props.error?.status || !!slots.statusCode ? (openBlock(), createBlock("p", {
                key: 0,
                "data-slot": "statusCode",
                class: ui.value.statusCode({ class: unref(uiProp)?.statusCode })
              }, [
                renderSlot(_ctx.$slots, "statusCode", {}, () => [
                  createTextVNode(toDisplayString(props.error?.statusCode || props.error?.status), 1)
                ])
              ], 2)) : createCommentVNode("", true),
              !!props.error?.statusMessage || !!props.error?.statusText || !!slots.statusMessage ? (openBlock(), createBlock("h1", {
                key: 1,
                "data-slot": "statusMessage",
                class: ui.value.statusMessage({ class: unref(uiProp)?.statusMessage })
              }, [
                renderSlot(_ctx.$slots, "statusMessage", {}, () => [
                  createTextVNode(toDisplayString(props.error?.statusMessage || props.error?.statusText), 1)
                ])
              ], 2)) : createCommentVNode("", true),
              props.error?.message && props.error.message !== (props.error.statusMessage || props.error.statusText) || !!slots.message ? (openBlock(), createBlock("p", {
                key: 2,
                "data-slot": "message",
              ...
              !!__props.clear || !!slots.links ? (openBlock(), createBlock("div", {
                ...
                renderSlot(_ctx.$slots, "links", {}, () => [
                  __props.clear ? (openBlock(), createBlock(_sfc_main$9, mergeProps({
                    key: 0,
                    size: "lg",
                    color: "primary",
                    variant: "solid",
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/Error.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UApp, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UError, { error: __props.error }, null, _parent2, _scopeId));
          } else {
            return [
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.4.5_@babel+core@7.29.0_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0__@parc_e0d214813e32dffbc06513e290b3a4a6/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { inputIdInjectionKey as $, get as A, _sfc_main$a as B, pickLinkProps as C, _sfc_main$b as D, omit as E, FieldGroupReset as F, navigateTo as G, _sfc_main$d as H, __nuxt_component_8 as I, useBreakpoints as J, breakpointsTailwind as K, useResizeObserver as L, useCollection as M, useRoute$1 as N, __nuxt_component_5 as O, Primitive as P, useForwardProps as Q, useComponentIcons as R, looseToNumber as S, formBusInjectionKey as T, formStateInjectionKey as U, formErrorsInjectionKey as V, formInputsInjectionKey as W, formLoadingInjectionKey as X, formOptionsInjectionKey as Y, useEventBus as Z, _sfc_main$9 as _, useForwardExpose as a, formFieldInjectionKey as a0, createRef as a1, injectConfigProviderContext as a2, VisuallyHidden_default as a3, Teleport_default as a4, getDisplayValue as a5, pausableFilter as a6, useMouseInElement as a7, getSlotChildrenText as a8, defineKeyedFunctionFactory as a9, useRouter as aA, useParentElement as aB, transformUI as aC, useColorMode as aD, refDebounced as aE, refThrottled as aF, __nuxt_component_1$1 as aG, formatTimeAgo as aH, fetchDefaults as aa, useAsyncData as ab, useNuxtApp as ac, useStorage as ad, tryOnBeforeUnmount as ae, createSharedComposable as af, refAutoReset as ag, onKeyStroke as ah, createGlobalState as ai, AUTOFOCUS_ON_MOUNT as aj, focusFirst as ak, getTabbableCandidates as al, focus as am, AUTOFOCUS_ON_UNMOUNT as an, EVENT_OPTIONS as ao, getTabbableEdges as ap, computedEager as aq, useEmitAsProps as ar, tryOnScopeDispose as as, useEventListener as at, syncRef as au, useDebounceFn as av, useActiveElement as aw, injectTooltipProviderContext as ax, useTimeoutFn as ay, isClient as az, useVModel as b, createContext as c, Presence_default as d, entry_default as default, useAppConfig as e, useComponentUI as f, useForwardPropsEmits as g, useFormField as h, isNullish as i, _sfc_main$e as j, _sfc_main$8 as k, reactiveComputed as l, unrefElement as m, createEventHook as n, usePrimitiveElement as o, getActiveElement as p, useLocale as q, reactivePick as r, useFieldGroup as s, tv as t, useToast as u, usePortal as v, reactiveOmit as w, createReusableTemplate as x, isArrayOfArray as y, _sfc_main$c as z };
