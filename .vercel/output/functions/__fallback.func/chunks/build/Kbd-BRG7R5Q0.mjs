import { e as useAppConfig, f as useComponentUI, t as tv, P as Primitive, af as createSharedComposable, a as useForwardExpose, g as useForwardPropsEmits, d as Presence_default, a4 as Teleport_default, b as useVModel, c as createContext, Q as useForwardProps, au as syncRef, o as usePrimitiveElement, ar as useEmitAsProps, ag as refAutoReset, as as tryOnScopeDispose, w as reactiveOmit, n as createEventHook, M as useCollection, p as getActiveElement, at as useEventListener } from './server.mjs';
...
import { d as PopperArrow_default, c as PopperAnchor_default, P as PopperRoot_default, a as useId, u as useDirection, D as DismissableLayer_default, i as PopperContent_default, f as useBodyScrollLock, g as useHideOthers, e as useFocusGuards, F as FocusScope_default, j as getOpenState, S as SUB_CLOSE_KEYS, k as getCheckedState, l as isIndeterminate, m as SELECTION_KEYS, n as SUB_OPEN_KEYS, o as isMouseEvent, b as useTypeahead, p as PopperContentPropsDefaultValue, q as isPointerInGraceArea, r as FIRST_LAST_KEYS, L as LAST_KEYS, h as focusFirst, I as ITEM_SELECT } from './PopperArrow-CvIo2SqJ.mjs';
import { R as RovingFocusGroup_default, u as useLocale } from './RovingFocusGroup-ByIEls-F.mjs';
import { computed, unref, mergeProps, withCtx, renderSlot, createTextVNode, toDisplayString, defineComponent, openBlock, createBlock, normalizeProps, guardReactiveProps, createVNode, toRefs, ref, resolveDynamicComponent, isRef, withKeys, nextTick, reactive, watchEffect, withModifiers, watch, watchSyncEffect, mergeDefaults, useSSRContext, createElementBlock, Fragment, createElementVNode } from 'vue';
...
var ContextMenuTrigger_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function clearLongPress() {
      (void 0).clearTimeout(longPressTimer.value);
    }
    ...
    async function handlePointerDown(event) {
      if (!disabled.value) {
        ...
        if (isTouchOrPen(event) && !event.defaultPrevented) {
          clearLongPress();
          longPressTimer.value = (void 0).setTimeout(handleOpen, rootContext.pressOpenDelay.value, event);
        }
      }
    }
...
const ContextMenu = {
  Root: ContextMenuRoot_default,
  Trigger: ContextMenuTrigger_default,
  Portal: ContextMenuPortal_default,
  ...
  ItemIndicator: ContextMenuItemIndicator_default,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/Kbd.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { ContextMenuRoot_default as C, DropdownMenuRoot_default as D, HoverCard as H, Popover as P, RangeCalendar as R, _sfc_main as _, ContextMenuTrigger_default as a, ContextMenu as b, useGraceArea as c, DropdownMenuTrigger_default as d, DropdownMenuArrow_default as e, DropdownMenu as f, useArrowNavigation as g, Calendar as h, getWeekNumber as i, useKbd$1 as j, useKbd as u };
