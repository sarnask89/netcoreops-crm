import { defineComponent, ref, computed, watch, mergeProps, withCtx, isRef, unref, createVNode, renderSlot, useSlots, useModel, useId, toRef, openBlock, createBlock, createCommentVNode, mergeModels, createSlots, Fragment, renderList, useTemplateRef, onScopeDispose, resolveDynamicComponent, toHandlers, createTextVNode, toDisplayString, withAsyncContext, withKeys, toRefs, watchEffect, withModifiers, normalizeStyle, createElementBlock, createElementVNode, toValue, withMemo, nextTick, watchSyncEffect, cloneVNode, getCurrentInstance, useSSRContext } from 'vue';
...
import { ac as useNuxtApp, e as useAppConfig, f as useComponentUI, t as tv, P as Primitive, N as useRoute$1, q as useLocale, x as createReusableTemplate, Q as useForwardProps, w as reactiveOmit, _ as _sfc_main$9$1, aC as transformUI, aD as useColorMode, r as reactivePick, E as omit, g as useForwardPropsEmits, v as usePortal, F as FieldGroupReset, a3 as VisuallyHidden_default, j as _sfc_main$e$1, aE as refDebounced, aF as refThrottled, B as _sfc_main$a$1, C as pickLinkProps, A as get$1, D as _sfc_main$b$1, z as _sfc_main$c$1, H as _sfc_main$d$1, aG as __nuxt_component_1$1, aH as formatTimeAgo, G as navigateTo, M as useCollection, a as useForwardExpose, o as usePrimitiveElement, b as useVModel, ag as refAutoReset, aB as useParentElement, p as getActiveElement, c as createContext, n as createEventHook } from './server.mjs';
import { p as provideDashboardContext, u as useDashboard, a as useResizable, b as _sfc_main$d, _ as _sfc_main$1$1 } from './DashboardSidebarToggle-C_vEEhTE.mjs';
import { av as defu, aw as isEqual } from '../nitro/nitro.mjs';
import { _ as _sfc_main$c, e as DialogTrigger_default, f as DialogPortal_default, b as DialogTitle_default, c as DialogDescription_default, D as DialogRoot_default, g as DialogOverlay_default, a as DialogContent_default } from './Slideover-DjbGE3Jt.mjs';
import { _ as _sfc_main$b } from './Modal-CNftcmQ6.mjs';
import { p as pointerDownOutside } from './overlay-CjyBzL1C.mjs';
import { _ as _sfc_main$e, j as useKbd$1 } from './Kbd-BRG7R5Q0.mjs';
import { _ as _sfc_main$f } from './Tooltip-Cmw1Q6xY.mjs';
import { _ as _sfc_main$a } from './NavigationMenu-C-dWmEMF.mjs';
import { _ as _sfc_main$g } from './DropdownMenu-C0QiZHaA.mjs';
import { u as useFetch } from './fetch-B7i171gV.mjs';
import { a as useId$1, b as useTypeahead, u as useDirection, s as getNextMatch } from './PopperArrow-CvIo2SqJ.mjs';
...
import { M as MAP_KEY_TO_FOCUS_INTENT, g as getFocusIntent } from './RovingFocusGroup-ByIEls-F.mjs';
import { h as handleAndDispatchCustomEvent } from './handleAndDispatchCustomEvent-Bk_AVSSo.mjs';
import { u as useVirtualizer } from './index-DC8E8gNZ.mjs';
import { _ as _sfc_main$h } from './Input-DVuEqpoa.mjs';
import { d as defineShortcuts } from './defineShortcuts-CclyHdTB.mjs';
import { u as useDashboard$1 } from './useDashboard-C83QFG82.mjs';
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$5), ...appConfig.ui?.dashboardGroup || {} }));
...
_sfc_main$9.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/DashboardGroup.vue");
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(FieldGroupReset), null, {
                    default: withCtx((_4, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (__props.overlay) {
                          _push4(ssrRenderComponent(unref(Bt), {
                            "data-slot": "overlay",
                        ...
                        _push4(ssrRenderComponent(unref(Ct), mergeProps({
                          "data-slot": "content",
                          ...
                          default: withCtx((_5, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              if (__props.handle) {
                                _push5(ssrRenderComponent(unref(Nt), {
                                  "data-slot": "handle",
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/Drawer.vue");
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/DashboardSidebar.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UButton, mergeProps({
        icon: instance.icon,
        label: __props.collapsed ? void 0 : instance.label,
        description: __props.collapsed ? void 0 : instance.description,
        color: "neutral",
        variant: "ghost",
        block: "",
        square: __props.collapsed,
        class: [!__props.collapsed && "py-2 justify-start"]
      }, _attrs), null, _parent));
    };
  }
});
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/DashboardSearchButton.vue");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UDropdownMenu, mergeProps({
        ...
        "chip-leading": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="inline-flex items-center justify-center shrink-0 size-5"${_scopeId}><span class="rounded-full ring ring-bg bg-(--chip-light) dark:bg-(--chip-dark) size-2" style="${ssrRenderStyle({
              "--chip-light": `var(--color-${item.chip}-500)`,
              "--chip-dark": `var(--color-${item.chip}-400)`
            })}"${_scopeId}></span></div>`);
          } else {
            return [
              createVNode("div", { class: "inline-flex items-center justify-center shrink-0 size-5" }, [
                createVNode("span", {
        ...
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UButton, mergeProps({
              ...
              label: __props.collapsed ? void 0 : unref(user).name
            }, {
              color: "neutral",
              variant: "ghost",
              block: "",
              ...
              !__props.collapsed ? {
                name: "default",
                fn: withCtx((_22, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="min-w-0 flex-1 text-left leading-tight"${_scopeId2}><div class="truncate font-medium"${_scopeId2}>${ssrInterpolate(unref(user).name)}</div><div class="truncate text-xs text-muted"${_scopeId2}>${ssrInterpolate(unref(account).data.role)}</div></div>`);
                    ...
                    return [
                      createVNode("div", { class: "min-w-0 flex-1 text-left leading-tight" }, [
                        createVNode("div", { class: "truncate font-medium" }, toDisplayString(unref(user).name), 1),
                        createVNode("div", { class: "truncate text-xs text-muted" }, toDisplayString(unref(account).data.role), 1)
                      ]),
...
function useFuse(search2, data, options) {
  ...
  return {
    ...
    results: computed(() => {
      ...
      if ((resolved === null || resolved === void 0 ? void 0 : resolved.matchAllWhenSearchEmpty) && !toValue(search2)) return toValue(data).map((item, index) => ({
        item,
        refIndex: index
      }));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(DefineItemTemplate), null, {
        default: withCtx(({ item, index, group }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$a$1, mergeProps(unref(pickLinkProps)(item), { custom: "" }), {
              default: withCtx(({ active, ...slotProps }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(ListboxItem_default), {
                    value: props.valueKey ? unref(get$1)(item, props.valueKey) : unref(omit)(item, ["matches", "group", "onSelect", "labelHtml", "suffixHtml", "children"]),
                            ...
                            if (_push5) {
                              ssrRenderSlot(_ctx.$slots, item.slot || group?.slot || "item", {
                                ...
                                ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : group?.slot ? `${group.slot}-leading` : `item-leading`, {
                                  ...
                                  if (item.loading) {
                                    _push5(ssrRenderComponent(_sfc_main$e$1, {
                                ...
                                if (item.prefix || (item.labelHtml || unref(get$1)(item, props.labelKey)) || (item.suffixHtml || item.suffix) || !!slots[item.slot ? `${item.slot}-label` : group?.slot ? `${group.slot}-label` : `item-label`] || (unref(get$1)(item, props.descriptionKey) || !!slots[item.slot ? `${item.slot}-description` : group?.slot ? `${group.slot}-description` : `item-description`])) {
                                  ...
                                  ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-label` : group?.slot ? `${group.slot}-label` : `item-label`, {
                                    ...
                                    if (item.labelHtml) {
                                      ...
                                      _push5(`<span data-slot="itemLabelBase" class="${ssrRenderClass(ui.value.itemLabelBase({ class: [unref(uiProp)?.itemLabelBase, item.ui?.itemLabelBase], active: active || item.active }))}"${_scopeId4}>${ssrInterpolate(unref(get$1)(item, props.labelKey))}</span>`);
                                    }
                                    if (item.suffixHtml) {
                                  ...
                                  _push5(`</span>`);
                                  if (unref(get$1)(item, props.descriptionKey) || !!slots[item.slot ? `${item.slot}-description` : group?.slot ? `${group.slot}-description` : `item-description`]) {
                                    ...
                                    ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-description` : group?.slot ? `${group.slot}-description` : `item-description`, {
                                      ...
                                      _push5(`${ssrInterpolate(unref(get$1)(item, props.descriptionKey))}`);
                                    }, _push5, _parent5, _scopeId4);
                                    _push5(`</span>`);
                                  } else {
                                    _push5(`<!---->`);
                                ...
                                if (!item.children?.length) {
                                  _push5(ssrRenderComponent(unref(ListboxItemIndicator_default), { "as-child": "" }, {
                                    default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(ssrRenderComponent(_sfc_main$e$1, {
                              ...
                              return [
                                renderSlot(_ctx.$slots, item.slot || group?.slot || "item", {
                                  ...
                                  item.prefix || (item.labelHtml || unref(get$1)(item, props.labelKey)) || (item.suffixHtml || item.suffix) || !!slots[item.slot ? `${item.slot}-label` : group?.slot ? `${group.slot}-label` : `item-label`] || (unref(get$1)(item, props.descriptionKey) || !!slots[item.slot ? `${item.slot}-description` : group?.slot ? `${group.slot}-description` : `item-description`]) ? (openBlock(), createBlock("span", {
                                    key: 0,
                                    ...
                                    unref(get$1)(item, props.descriptionKey) || !!slots[item.slot ? `${item.slot}-description` : group?.slot ? `${group.slot}-description` : `item-description`] ? (openBlock(), createBlock("span", {
                                      key: 0,
                                      ...
                                      renderSlot(_ctx.$slots, item.slot ? `${item.slot}-description` : group?.slot ? `${group.slot}-description` : `item-description`, {
                                        ...
                                        createTextVNode(toDisplayString(unref(get$1)(item, props.descriptionKey)), 1)
                                      ])
                                    ], 2)) : createCommentVNode("", true)
                                  ], 2)) : createCommentVNode("", true),
                                  createVNode("span", {
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(_sfc_main$h, mergeProps({
                      ...
                      history.value?.length && (__props.back || !!slots.back) ? {
                        name: "leading",
                        fn: withCtx((_4, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                  ...
                  if (filteredGroups.value?.length) {
                    ...
                    if (!!__props.virtualize) {
                      _push3(ssrRenderComponent(unref(ListboxVirtualizer_default), mergeProps({
                        ...
                        "text-content": (item2) => unref(get$1)(item2, props.labelKey)
                      ...
                      ssrRenderList(filteredGroups.value, (group) => {
                        _push3(ssrRenderComponent(unref(ListboxGroup_default), {
                          ...
                          default: withCtx((_4, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              if (unref(get$1)(group, props.labelKey) || !!slots[group.slot ? `${group.slot}-group-label` : "group-label"]) {
                                  ...
                                  default: withCtx((_5, _push5, _parent5, _scopeId4) => {
                                    if (_push5) {
                                      ssrRenderSlot(_ctx.$slots, group.slot ? `${group.slot}-group-label` : "group-label", {
                                        group,
                                        label: unref(get$1)(group, props.labelKey),
                                        ui: ui.value
                                      }, () => {
                                        _push5(`${ssrInterpolate(unref(get$1)(group, props.labelKey))}`);
                                      }, _push5, _parent5, _scopeId4);
                                    } else {
                                      return [
                                        renderSlot(_ctx.$slots, group.slot ? `${group.slot}-group-label` : "group-label", {
                                          ...
                                          createTextVNode(toDisplayString(unref(get$1)(group, props.labelKey)), 1)
                                        ])
                                      ];
                                    }
                                  }),
                              ...
                              return [
                                unref(get$1)(group, props.labelKey) || !!slots[group.slot ? `${group.slot}-group-label` : "group-label"] ? (openBlock(), createBlock(unref(ListboxGroupLabel_default), {
                                  key: 0,
                                  "data-slot": "label",
                                  class: ui.value.label({ class: unref(uiProp)?.label })
                                }, {
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/CommandPalette.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/DashboardSearch.vue");
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: notifications } = ([__temp, __restore] = withAsyncContext(() => useFetch(
      "/api/notifications",
      "$P_pT2Uo9ag"
      /* nuxt-injected */
    )), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_USlideover = _sfc_main$c;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const flatLinks = computed(() => flattenNavigationItems(links.flat()));
    const groups = computed(() => {
      const baseGroups = [{
        id: "links",
        label: "Nawigacja",
    ...
    function flattenNavigationItems(items) {
      return items.flatMap((item) => {
        ...
        return [{
          ...
          to: typeof item.to === "string" ? item.to : void 0,
          target: typeof item.target === "string" ? item.target : void 0,
          onSelect: item.onSelect ? () => item.onSelect?.(new Event("select")) : void 0
        }];
      });
    }
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UDashboardGroup = _sfc_main$9;
