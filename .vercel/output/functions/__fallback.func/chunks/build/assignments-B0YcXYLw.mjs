...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    async function deleteAssignment(row) {
      if (!(void 0).confirm(`Usunąć przypisanie ${row.customer.fullName} / ${row.tariff.name}?`)) return;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UDashboardPanel, mergeProps({
        id: "billing-assignments",
        ui: { body: "p-0 sm:p-0 gap-0 sm:gap-0" }
      }, _attrs), {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UDashboardNavbar, { title: "Przypisania" }, {
              ...
              right: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_USlideover, {
                    ...
                    title: unref(editingAssignmentId) ? "Edytuj przypisanie" : "Dodaj przypisanie"
                  }, {
            ...
            return [
              createVNode(_component_UDashboardNavbar, { title: "Przypisania" }, {
                leading: withCtx(() => [
                  createVNode(_component_UDashboardSidebarCollapse)
                ]),
                right: withCtx(() => [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/billing/assignments.vue");
