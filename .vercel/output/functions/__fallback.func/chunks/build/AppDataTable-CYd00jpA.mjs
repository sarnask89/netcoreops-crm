import { useSlots, toRef, computed, unref, mergeProps, withCtx, renderSlot, createSlots, renderList, openBlock, createBlock, createCommentVNode, createVNode, defineComponent, ref, watch, toDisplayString, isRef, createTextVNode, Fragment, resolveDynamicComponent, toRefs, normalizeProps, guardReactiveProps, useSSRContext } from 'vue';
...
import { e as useAppConfig, f as useComponentUI, g as useForwardPropsEmits, r as reactivePick, t as tv, q as useLocale, v as usePortal, w as reactiveOmit, x as createReusableTemplate, y as isArrayOfArray, j as _sfc_main$e, z as _sfc_main$c, A as get, F as FieldGroupReset, B as _sfc_main$a, C as pickLinkProps, D as _sfc_main$b, E as omit, _ as _sfc_main$9, a as useForwardExpose, b as useVModel, P as Primitive, c as createContext } from './server.mjs';
import { C as ContextMenuRoot_default, a as ContextMenuTrigger_default, _ as _sfc_main$5, b as ContextMenu } from './Kbd-BRG7R5Q0.mjs';
import { _ as _sfc_main$4 } from './Table-9O8FnRDu.mjs';
        ...
        default: withCtx(({ item, active, index }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, item.slot || "item", {
              ...
              _push2(ssrRenderComponent(unref(ContextMenu).ItemIndicator, { "as-child": "" }, {
            ...
            return [
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                createVNode("span", {
                  ...
                  createVNode(unref(ContextMenu).ItemIndicator, { "as-child": "" }, {
                    default: withCtx(() => [
                      createVNode(_sfc_main$e, {
                        name: __props.checkedIcon || unref(appConfig).ui.icons.check,
                        "data-slot": "itemTrailingIcon",
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(FieldGroupReset), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ssrRenderVNode(_push3, createVNode(resolveDynamicComponent(__props.sub ? unref(ContextMenu).SubContent : unref(ContextMenu).Content), mergeProps({
                    "data-slot": "content",
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        ssrRenderList(groups.value, (group, groupIndex) => {
                          _push4(ssrRenderComponent(unref(ContextMenu).Group, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                ssrRenderList(group, (item, index) => {
                                  _push5(`<!--[-->`);
                                  if (item.type === "label") {
                                    _push5(ssrRenderComponent(unref(ContextMenu).Label, {
                                      "data-slot": "label",
                                    ...
                                    _push5(ssrRenderComponent(unref(ContextMenu).Separator, {
                                      "data-slot": "separator",
                                      class: __props.ui.separator({ class: [__props.uiOverride?.separator, item.ui?.separator, item.class] })
                                    }, null, _parent5, _scopeId4));
                                  } else if (item?.children?.length) {
                                    _push5(ssrRenderComponent(unref(ContextMenu).Sub, {
                                      open: item.open,
                                      "default-open": item.defaultOpen
                                    }, {
                                      default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                        if (_push6) {
                                          _push6(ssrRenderComponent(unref(ContextMenu).SubTrigger, {
                                            as: "button",
                                            type: "button",
                                    ...
                                    _push5(ssrRenderComponent(unref(ContextMenu).CheckboxItem, {
                                    ...
                                    _push5(ssrRenderComponent(_sfc_main$a, mergeProps({ ref_for: true }, unref(pickLinkProps)(item), { custom: "" }), {
                                      default: withCtx(({ active, ...slotProps }, _push6, _parent6, _scopeId5) => {
                                        if (_push6) {
                                          _push6(ssrRenderComponent(unref(ContextMenu).Item, {
                                            "as-child": "",
                                            disabled: item.disabled,
                                            "text-value": unref(get)(item, props.labelKey),
                                            onSelect: item.onSelect
                                            ...
                                            default: withCtx((_5, _push7, _parent7, _scopeId6) => {
                                              if (_push7) {
                                                _push7(ssrRenderComponent(_sfc_main$b, mergeProps({ ref_for: true }, slotProps, {
                                                  "data-slot": "item",
                                          ...
                                          return [
                                            createVNode(unref(ContextMenu).Item, {
                                              "as-child": "",
                                              disabled: item.disabled,
                                              "text-value": unref(get)(item, props.labelKey),
                                              onSelect: item.onSelect
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/ContextMenuContent.vue");
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(ContextMenuRoot_default), mergeProps(unref(rootProps), _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!!slots.default) {
              _push2(ssrRenderComponent(unref(ContextMenuTrigger_default), {
                "as-child": "",
            ...
            return [
              !!slots.default ? (openBlock(), createBlock(unref(ContextMenuTrigger_default), {
                key: 0,
                "as-child": "",
                disabled: __props.disabled,
                class: props.class
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/ContextMenu.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_f232df4310342c42e02e10fb94bda86b/node_modules/@nuxt/ui/dist/runtime/components/Pagination.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    contextItems: {},
    emptyLabel: { default: "Brak danych" },
    pageSize: { default: 25 }
  },
  setup(__props) {
    const props = __props;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UContextMenu, mergeProps({ items: unref(items) }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex h-full min-h-0 w-full flex-col overflow-hidden border-y border-default bg-default"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UTable, {
              data: unref(pagedData),
              ...
              empty: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="py-10 text-center text-sm text-muted"${_scopeId2}>${ssrInterpolate(__props.emptyLabel)}</div>`);
                } else {
                  return [
                    createVNode("div", { class: "py-10 text-center text-sm text-muted" }, toDisplayString(__props.emptyLabel), 1)
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            if (__props.pageSize > 0 && unref(total) > __props.pageSize) {
              _push2(`<div class="flex items-center justify-between border-t border-default px-3 py-2"${_scopeId}><div class="text-xs text-muted"${_scopeId}>${ssrInterpolate(Math.min((unref(page) - 1) * __props.pageSize + 1, unref(total)))}-${ssrInterpolate(Math.min(unref(page) * __props.pageSize, unref(total)))} z ${ssrInterpolate(unref(total))}</div>`);
            ...
            return [
              createVNode("div", {
                ...
                __props.pageSize > 0 && unref(total) > __props.pageSize ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: "flex items-center justify-between border-t border-default px-3 py-2"
                }, [
                  createVNode("div", { class: "text-xs text-muted" }, toDisplayString(Math.min((unref(page) - 1) * __props.pageSize + 1, unref(total))) + "-" + toDisplayString(Math.min(unref(page) * __props.pageSize, unref(total))) + " z " + toDisplayString(unref(total)), 1),
                  createVNode(_component_UPagination, {
                    ...
                    total: unref(total),
                    size: "xs"
                  }, null, 8, ["page", "onUpdate:page", "items-per-page", "total"])
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/AppDataTable.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_6 = Object.assign(_sfc_main, { __name: "AppDataTable" });

export { __nuxt_component_6 as _, _sfc_main$2 as a };
