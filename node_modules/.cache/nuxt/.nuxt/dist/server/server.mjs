import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef as toRef$1, defineComponent, computed, unref, provide, ref, watch, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, nextTick, defineAsyncComponent, customRef, toValue as toValue$1, shallowReadonly, onScopeDispose, readonly, watchEffect, toRefs, Fragment, renderSlot, toHandlerKey, camelize as camelize$1, Comment, mergeProps, cloneVNode, openBlock, createBlock, withCtx, Teleport, createCommentVNode, markRaw, createTextVNode, toDisplayString, createElementBlock, createVNode, withModifiers, normalizeProps, guardReactiveProps, normalizeStyle, onServerPrefetch, resolveDynamicComponent, useSSRContext, useModel, mergeModels, resolveComponent, useSlots, renderList, useTemplateRef, useId, Suspense, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "/home/sarna/netcoreops/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/sarna/netcoreops/node_modules/.pnpm/hookable@6.1.1/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/sarna/netcoreops/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/home/sarna/netcoreops/node_modules/.pnpm/@nuxt+nitro-server@4.4.5_@babel+core@7.29.0_db0@0.3.4_drizzle-orm@0.45.2_@opentelemetry_3474243ea9be90cd80c921245ccbee2e/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { hasProtocol, joinURL, parseURL as parseURL$1, encodePath as encodePath$1, decodePath, withQuery, isScriptProtocol, parseQuery as parseQuery$1, withTrailingSlash, withoutTrailingSlash } from "/home/sarna/netcoreops/node_modules/.pnpm/ufo@1.6.4/node_modules/ufo/dist/index.mjs";
import defu$1, { defu, defuFn } from "/home/sarna/netcoreops/node_modules/.pnpm/defu@6.1.7/node_modules/defu/dist/defu.mjs";
import { useHead as useHead$1, headSymbol, useSeoMeta as useSeoMeta$1 } from "/home/sarna/netcoreops/node_modules/.pnpm/@unhead+vue@2.1.13_vue@3.5.34_typescript@6.0.3_/node_modules/@unhead/vue/dist/index.mjs";
import { klona } from "/home/sarna/netcoreops/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs";
import colors from "tailwindcss/colors";
import { ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderSuspense } from "vue/server-renderer";
import { debounce } from "/home/sarna/netcoreops/node_modules/.pnpm/perfect-debounce@2.1.0/node_modules/perfect-debounce/dist/index.mjs";
if (!globalThis.$fetch) {
    ...
    return (failure ? Promise.resolve(failure) : navigate(toLocation, from)).catch((error) => isNavigationFailure(error) ? isNavigationFailure(error, ErrorTypes.NAVIGATION_GUARD_REDIRECT) ? error : markAsReady(error) : triggerError(error, toLocation, from)).then((failure2) => {
      if (failure2) {
        if (isNavigationFailure(failure2, ErrorTypes.NAVIGATION_GUARD_REDIRECT)) {
          if (process.env.NODE_ENV !== "production" && isSameRouteLocation(stringifyQuery$1, resolve(failure2.to), toLocation) && redirectedFrom && (redirectedFrom._count = redirectedFrom._count ? redirectedFrom._count + 1 : 1) > 30) {
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/diagnostics-D4iIDcPI.js")
  },
  {
    name: "network-ftth-imports",
    path: "/network/ftth/imports",
    component: () => import("./_nuxt/imports-UP1Uy9iD.js")
  },
  {
    name: "network-ftth-mac-map",
    path: "/network/ftth/mac-map",
    component: () => import("./_nuxt/mac-map-CS_19TJq.js")
  },
  {
    name: "network-ftth-olts",
    path: "/network/ftth/olts",
    component: () => import("./_nuxt/olts-DBtKI7Ws.js")
  },
  {
    name: "network-ftth-onus",
    path: "/network/ftth/onus",
    component: () => import("./_nuxt/onus-Dxb2JxnT.js")
  },
  {
    name: "network-ftth-pons",
    path: "/network/ftth/pons",
    component: () => import("./_nuxt/pons-DDBAtRMM.js")
  },
  {
    name: "automation-definitions",
    path: "/automation/definitions",
    component: () => import("./_nuxt/definitions-D83F4JMR.js")
  },
  {
    name: "automation-scripts",
    path: "/automation/scripts",
    component: () => import("./_nuxt/scripts-CzVF9Czk.js")
  },
  {
    name: "billing-assignments",
    path: "/billing/assignments",
    component: () => import("./_nuxt/assignments-B0YcXYLw.js")
  },
  {
    name: "billing-subscriptions",
    path: "/billing/subscriptions",
    component: () => import("./_nuxt/subscriptions-C13Iz-8Q.js")
  },
  {
    name: "billing-tariffs",
    path: "/billing/tariffs",
    component: () => import("./_nuxt/tariffs-D6dSx8ru.js")
  },
  {
    name: "crm-customer-devices",
    path: "/crm/customer-devices",
    component: () => import("./_nuxt/customer-devices-Gb9xOCI_.js")
  },
  {
    name: "crm-customers",
    path: "/crm/customers",
    component: () => import("./_nuxt/customers-Dzn4PEyM.js")
  },
  {
    name: "network-access-profiles",
    path: "/network/access-profiles",
    component: () => import("./_nuxt/access-profiles-N9h5xAfV.js")
  },
  {
    name: "network-equipment",
    path: "/network/equipment",
    component: () => import("./_nuxt/equipment-PVQ7yf3v.js")
  },
  {
    name: "network-ftth",
    path: "/network/ftth",
    component: () => import("./_nuxt/index-Bt_JcpOL.js")
  },
  {
    name: "network-imports",
    path: "/network/imports",
    component: () => import("./_nuxt/imports-Cm_k2Q2p.js")
  },
  {
    name: "network-lines",
    path: "/network/lines",
    component: () => import("./_nuxt/lines-DxUBPdMc.js")
  },
  {
    name: "network-nodes",
    path: "/network/nodes",
    component: () => import("./_nuxt/nodes-9I2h8HEG.js")
  },
  {
    name: "pit-validation",
    path: "/pit/validation",
    component: () => import("./_nuxt/validation-DmR89HJo.js")
  },
  {
    name: "system-dictionaries",
    path: "/system/dictionaries",
    component: () => import("./_nuxt/dictionaries-COPFr0ve.js")
  },
  {
    name: "customers",
    path: "/customers",
    component: () => import("./_nuxt/customers-BYu0c6TY.js")
  },
  {
    name: "inbox",
    path: "/inbox",
    component: () => import("./_nuxt/inbox-C0Xcdop3.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/login-DaNx4fdK.js")
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/settings",
    component: () => import("./_nuxt/settings-G2v98J1j.js"),
    children: [
      {
        name: "settings-members",
        path: "members",
        component: () => import("./_nuxt/members-Pq-YL6pV.js")
      },
      {
        name: "settings-notifications",
        path: "notifications",
        component: () => import("./_nuxt/notifications-DO55do4j.js")
      },
      {
        name: "settings-security",
        path: "security",
        component: () => import("./_nuxt/security-DuDsgwiK.js")
      },
      {
        name: "settings",
        path: "",
        component: () => import("./_nuxt/index-B2YrgjVD.js")
      }
    ]
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DmgQX54B.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-JWCutDz7.js").then((m) => m.default || m))
};
...
export {
  inputIdInjectionKey as $,
  get as A,
  _sfc_main$a as B,
  pickLinkProps as C,
  _sfc_main$b as D,
  omit as E,
  FieldGroupReset as F,
  navigateTo as G,
  _sfc_main$d as H,
  __nuxt_component_8 as I,
  useBreakpoints as J,
  breakpointsTailwind as K,
  useResizeObserver as L,
  useCollection as M,
  useRoute$1 as N,
  __nuxt_component_5 as O,
  Primitive as P,
  useForwardProps as Q,
  useComponentIcons as R,
  looseToNumber as S,
  formBusInjectionKey as T,
  formStateInjectionKey as U,
  formErrorsInjectionKey as V,
  formInputsInjectionKey as W,
  formLoadingInjectionKey as X,
  formOptionsInjectionKey as Y,
  useEventBus as Z,
  _sfc_main$9 as _,
  useForwardExpose as a,
  formFieldInjectionKey as a0,
  createRef as a1,
  injectConfigProviderContext as a2,
  VisuallyHidden_default as a3,
  Teleport_default as a4,
  getDisplayValue as a5,
  pausableFilter as a6,
  useMouseInElement as a7,
  getSlotChildrenText as a8,
  defineKeyedFunctionFactory as a9,
  useRouter as aA,
  useParentElement as aB,
  transformUI as aC,
  useColorMode as aD,
  refDebounced as aE,
  refThrottled as aF,
  __nuxt_component_1$1 as aG,
  formatTimeAgo as aH,
  fetchDefaults as aa,
  useAsyncData as ab,
  useNuxtApp as ac,
  useStorage as ad,
  tryOnBeforeUnmount as ae,
  createSharedComposable as af,
  refAutoReset as ag,
  onKeyStroke as ah,
  createGlobalState as ai,
  AUTOFOCUS_ON_MOUNT as aj,
  focusFirst as ak,
  getTabbableCandidates as al,
  focus as am,
  AUTOFOCUS_ON_UNMOUNT as an,
  EVENT_OPTIONS as ao,
  getTabbableEdges as ap,
  computedEager as aq,
  useEmitAsProps as ar,
  tryOnScopeDispose as as,
  useEventListener as at,
  syncRef as au,
  useDebounceFn as av,
  useActiveElement as aw,
  injectTooltipProviderContext as ax,
  useTimeoutFn as ay,
  isClient as az,
  useVModel as b,
  createContext as c,
  Presence_default as d,
  entry_default as default,
  useAppConfig as e,
  useComponentUI as f,
  useForwardPropsEmits as g,
  useFormField as h,
  isNullish as i,
  _sfc_main$e as j,
  _sfc_main$8 as k,
  reactiveComputed as l,
  unrefElement as m,
  createEventHook as n,
  usePrimitiveElement as o,
