import { defineComponent, toRefs, computed, openBlock, createBlock, unref, mergeProps, withKeys, withModifiers, withCtx, renderSlot, createCommentVNode, useSlots, useId, useAttrs, Fragment, createVNode, createTextVNode, toDisplayString, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrInterpolate } from "vue/server-renderer";
import { b as useVModel, a as useForwardExpose, P as Primitive, c as createContext, e as useAppConfig, f as useComponentUI, g as useForwardPropsEmits, r as reactivePick, h as useFormField, t as tv, j as _sfc_main$1 } from "../server.mjs";
import { L as Label_default } from "./FormField-D5WtVCdC.js";
                      ...
                      if (_push4) {
                        ...
                        return [
                          __props.loading ? (openBlock(), createBlock(_sfc_main$1, {
                            ...
                            __props.checkedIcon ? (openBlock(), createBlock(_sfc_main$1, {
                              key: 0,
                              name: __props.checkedIcon,
                              "data-slot": "icon",
                              class: ui.value.icon({ class: unref(uiProp)?.icon, checked: true })
                            }, null, 8, ["name", "class"])) : createCommentVNode("", true),
                            __props.uncheckedIcon ? (openBlock(), createBlock(_sfc_main$1, {
                              key: 1,
                              name: __props.uncheckedIcon,
                              "data-slot": "icon",
                              class: ui.value.icon({ class: unref(uiProp)?.icon, unchecked: true })
