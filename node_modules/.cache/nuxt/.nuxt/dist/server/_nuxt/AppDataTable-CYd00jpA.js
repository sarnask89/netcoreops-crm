import { defineComponent, openBlock, createBlock, unref, mergeProps, withCtx, renderSlot, createTextVNode, toRefs, computed, normalizeProps, guardReactiveProps, toDisplayString, useSlots, toRef, createVNode, createCommentVNode, Fragment, renderList, resolveDynamicComponent, createSlots, useSSRContext, ref, watch, isRef } from "vue";
...
import { a as useForwardExpose, P as Primitive, b as useVModel, c as createContext, q as useLocale, e as useAppConfig, v as usePortal, g as useForwardPropsEmits, w as reactiveOmit, x as createReusableTemplate, y as isArrayOfArray, j as _sfc_main$4, z as _sfc_main$5, A as get, F as FieldGroupReset, B as _sfc_main$7, C as pickLinkProps, D as _sfc_main$8, E as omit, f as useComponentUI, r as reactivePick, t as tv, _ as _sfc_main$9 } from "../server.mjs";
import { _ as _sfc_main$6, C as ContextMenu, a as ContextMenuRoot_default, b as ContextMenuTrigger_default } from "./Kbd-BRG7R5Q0.js";
import { _ as _sfc_main$a } from "./Table-9O8FnRDu.js";
            ...
            return [
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                  ...
                  item.loading ? (openBlock(), createBlock(_sfc_main$4, {
                    key: 0,
                    name: __props.loadingIcon || unref(appConfig).ui.icons.loading,
                    "data-slot": "itemLeadingIcon",
                    class: __props.ui.itemLeadingIcon({ class: [__props.uiOverride?.itemLeadingIcon, item.ui?.itemLeadingIcon], color: item?.color, loading: true })
                  }, null, 8, ["name", "class"])) : item.icon ? (openBlock(), createBlock(_sfc_main$4, {
                    key: 1,
                    name: item.icon,
                    "data-slot": "itemLeadingIcon",
                    class: __props.ui.itemLeadingIcon({ class: [__props.uiOverride?.itemLeadingIcon, item.ui?.itemLeadingIcon], color: item?.color, active })
                ...
                unref(get)(item, props.labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"] || (unref(get)(item, props.descriptionKey) || !!slots[item.slot ? `${item.slot}-description` : "item-description"]) ? (openBlock(), createBlock("span", {
                  ...
                  createVNode("span", {
                    ...
                    item.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$4, {
                      key: 0,
                      name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig).ui.icons.external,
                      "data-slot": "itemLabelExternalIcon",
                      class: __props.ui.itemLabelExternalIcon({ class: [__props.uiOverride?.itemLabelExternalIcon, item.ui?.itemLabelExternalIcon], color: item?.color, active })
                ...
                createVNode("span", {
                  ...
                  renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                    ...
                    item.children?.length ? (openBlock(), createBlock(_sfc_main$4, {
                      key: 0,
                      name: childrenIcon.value,
                      "data-slot": "itemTrailingIcon",
                      class: __props.ui.itemTrailingIcon({ class: [__props.uiOverride?.itemTrailingIcon, item.ui?.itemTrailingIcon], color: item?.color, active })
                              ...
                              if (_push5) {
                                ...
                                ssrRenderList(group, (item, index) => {
                                  ...
                                  if (item.type === "label") {
                                    ...
                                    _push5(ssrRenderComponent(_sfc_main$7, mergeProps({ ref_for: true }, unref(pickLinkProps)(item), { custom: "" }), {
                                        ...
                                        if (_push6) {
                                          _push6(ssrRenderComponent(unref(ContextMenu).Item, {
                                            ...
                                            default: withCtx((_5, _push7, _parent7, _scopeId6) => {
                                              if (_push7) {
                                                _push7(ssrRenderComponent(_sfc_main$8, mergeProps({ ref_for: true }, slotProps, {
                                                  "data-slot": "item",
                                                ...
                                                return [
                                                  createVNode(_sfc_main$8, mergeProps({ ref_for: true }, slotProps, {
                                                    "data-slot": "item",
                                                    class: __props.ui.item({ class: [__props.uiOverride?.item, item.ui?.item, item.class], active, color: item?.color })
                                                  }), {
                                                    default: withCtx(() => [
                                  ...
                                  (openBlock(true), createBlock(Fragment, null, renderList(group, (item, index) => {
                                    return openBlock(), createBlock(Fragment, {
                                      ...
                                      item.type === "label" ? (openBlock(), createBlock(unref(ContextMenu).Label, {
                                        ...
                                        _: 2
                                      }, 1032, ["model-value", "disabled", "text-value", "class", "onUpdate:modelValue", "onSelect"])) : (openBlock(), createBlock(_sfc_main$7, mergeProps({
                                        key: 4,
                                        ref_for: true
