import { defineComponent, toRefs, ref, shallowRef, openBlock, createBlock, unref, withCtx, renderSlot, computed, createVNode, normalizeStyle, createCommentVNode, watch, watchPostEffect, mergeProps, withKeys, withModifiers, useSlots, createTextVNode, toDisplayString, Fragment, renderList, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderSlot, ssrRenderList, ssrRenderClass, ssrInterpolate } from "vue/server-renderer";
import { a as useForwardExpose, b as useVModel, P as Primitive, c as createContext, d as Presence_default, L as useResizeObserver, e as useAppConfig, f as useComponentUI, g as useForwardPropsEmits, r as reactivePick, t as tv, A as get, j as _sfc_main$1, z as _sfc_main$2 } from "../server.mjs";
import { u as useDirection, a as useId } from "./PopperArrow-CvIo2SqJ.js";
import { R as RovingFocusGroup_default } from "./RovingFocusGroup-ByIEls-F.js";
