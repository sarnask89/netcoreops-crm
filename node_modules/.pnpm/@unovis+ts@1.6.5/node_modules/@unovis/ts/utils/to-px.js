...
function parseUnit(str) {
    ...
    const unit = ((_a = str.match(/[\d.\-+]*\s*(.*)/)) === null || _a === void 0 ? void 0 : _a[1]) || '';
    return [num, unit];
}
function isBrowser() {
...
function getPropertyInPX(element, prop) {
    ...
    return parts[0] * ((_a = toPx(parts[1], element)) !== null && _a !== void 0 ? _a : 1);
}
...
function toPx(str, element) {
    ...
    if (!isBrowser()) {
        ...
        if (!isNaN(parts[0])) {
            const unit = ((_a = parts[1]) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || 'px';
            if (unit === 'px' || unit === '')
                return parts[0];
            if (unit === 'em' || unit === 'rem')
                return parts[0] * 16; // Assume 16px base
            if (unit === 'in')
                return parts[0] * 96;
            if (unit === 'cm')
                return parts[0] * (96 / 2.54);
            if (unit === 'mm')
                return parts[0] * (96 / 25.4);
            if (unit === 'pt')
                return parts[0] * (96 / 72);
            if (unit === 'pc')
                return parts[0] * (96 / 6);
        }
        return null;
