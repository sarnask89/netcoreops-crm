...
const cssVarDefaults = {
    ...
    '--vis-map-point-label-font-family': undefined,
    ...
    '--vis-map-area-label-font-family': undefined,
    // Bottom label
...
const points = css `
  label: points;
`;
const clusterBackgroundCircle = css `
  label: cluster-background-circle;
`;
const point = css `
  label: point;
`;
const pointShape = css `
  label: point-shape;
...
`;
const flowParticles = css `
  label: flow-particles;
`;
const flowParticle = css `
  label: flow-particle;
  
  pointer-events: none;
`;
const sourcePoints = css `
  label: source-points;
`;
const sourcePoint = css `
  label: source-point;
...
export { areaLabel, background, clusterBackground, clusterBackgroundCircle, clusterDonut, cssVarDefaults, feature, features, flowParticle, flowParticles, link, links, point, pointBottomLabel, pointDonut, pointLabel, pointPathRing, pointSelection, pointSelectionRing, pointShape, points, root, sourcePoint, sourcePoints, variables };
