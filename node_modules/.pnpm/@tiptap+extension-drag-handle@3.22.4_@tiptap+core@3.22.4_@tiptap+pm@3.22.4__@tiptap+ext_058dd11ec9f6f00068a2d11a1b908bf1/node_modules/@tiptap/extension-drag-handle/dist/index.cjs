...
function getDragHandleRanges(event, editor, nestedOptions, dragContext) {
  ...
  return (0, import_extension_node_range.getSelectionRanges)($from, $to, 0, { extendOnBoundaryOverlap: false });
}
function dragHandler(event, editor, nestedOptions, dragContext) {
  ...
  const selectionRanges = (0, import_extension_node_range.getSelectionRanges)($from, $to, 0, { extendOnBoundaryOverlap: false });
